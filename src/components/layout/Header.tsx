        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex justify-between h-24 items-center">
                ...
                <div className="hidden md:flex space-x-8 items-center">
                    <Link to="/events" className="text-sm font-bold uppercase tracking-widest text-dark-muted hover:text-white transition-colors">Eventos</Link>
                    ...
                    <Link to="/events" className="bg-brand-600 text-white px-8 py-3 font-black text-sm hover:bg-brand-500 transition-all uppercase tracking-widest skew-x-[-10deg] shadow-[4px_4px_0px_0px_rgba(255,255,255,0.1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px]">
